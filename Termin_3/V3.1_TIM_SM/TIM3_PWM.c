...
// Initialisierung des Timer 3 für PWM (Servo + RGB-LED)
{
	...
	LL_TIM_OC_SetCompareCH1(TIM3,100-1);
	...
	LL_TIM_OC_SetCompareCH2(TIM3,200-1);
	LL_TIM_OC_SetCompareCH3(TIM3,500-1);
...
{
	if ((red >=0) && (red <=255))
		; LL_TIM_OC_SetCompareCH2(TIM3,red);
	if ((green >=0) && (green <=255))
		; LL_TIM_OC_SetCompareCH3(TIM3,green);
	if ((blue >=0) && (blue <=255))
		; LL_TIM_OC_SetCompareCH4(TIM3,blue);
}
